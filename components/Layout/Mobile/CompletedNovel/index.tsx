...
import { getNovelCompleted, getNovelHotest, getNovelUpdate } from '../../../../API/APIManage';

export function CompletedNovelMobile() {
  ...
  useEffect(() => {
    router.push(`/completed/${itemOffset}`);
  }, [itemOffset]);
